...
class ConfigPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const ConfigPageForm(),
    );
  }
}

class ConfigPageForm extends StatefulWidget {
  const ConfigPageForm({Key key}) : super(key: key);

  @override
  ConfigPageFormState createState() => ConfigPageFormState();
}
...
class ConfigPageFormState extends State<ConfigPageForm> with RestorationMixin {
  User person;
  UserBloc userBloc;
